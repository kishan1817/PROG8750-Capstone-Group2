...
<main>
    ...
    <ul class="nav-tabs">
        <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="../Admin/admin-pannel.php">Manage Employers</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="../Admin/manageuser.php">Manage Users</a>
        </li>
        <li class="nav-item">
